...
public class Fertilizer {
    public Fertilizer() {
        ...
        JLabel titleLabelFertilizer = new JLabel("FERTILIZER"); fertilizerFrame.add(titleLabelFertilizer);
        ...
        JComboBox crop = new JComboBox(cropOption); fertilizerFrame.add(crop);
        crop.setBounds(300,120,200,25);
        crop.setFont(new Font("Calibri (Body)",Font.PLAIN,16));

        String[] typeOption = {"Irrigated", "Rainfed"};
        JComboBox type = new JComboBox(typeOption); fertilizerFrame.add(type);
        ...
        JButton calculateButton = new JButton("Calculate"); fertilizerFrame.add(calculateButton);
        calculateButton.setBounds(250,220,100,25);
        JButton calculationLCCButton = new JButton("LCC"); fertilizerFrame.add(calculationLCCButton);
        ...
        calculationLCCButton.addActionListener(e -> {
            ...
            JTextField leaf2 = new JTextField(); fertilizerFrame.add(leaf2);
            ...
            JTextField leaf3 = new JTextField(); fertilizerFrame.add(leaf3);
            ...
            JTextField leaf4 = new JTextField(); fertilizerFrame.add(leaf4);
            ...
            JTextField leaf5 = new JTextField(); fertilizerFrame.add(leaf5);
            ...
            JTextField leaf6 = new JTextField(); fertilizerFrame.add(leaf6);
            ...
            JTextField leaf7 = new JTextField(); fertilizerFrame.add(leaf7);
            ...
            JTextField leaf8 = new JTextField(); fertilizerFrame.add(leaf8);
            ...
            JTextField leaf9 = new JTextField(); fertilizerFrame.add(leaf9);
            ...
            JTextField leaf10 = new JTextField(); fertilizerFrame.add(leaf10);
            ...
            JTextField average = new JTextField(); fertilizerFrame.add(average);
            ...
            JButton help = new JButton("Help"); fertilizerFrame.add(help);
            help.setBounds(780,520,100,25);
            JButton result = new JButton("Result"); fertilizerFrame.add(result);
            result.setBounds(1080,520,100,25);

            help.addActionListener(e1 -> {
                JFrame helpFrame = new JFrame("Help");

                JLabel helpTitleLabel = new JLabel("Help!"); helpFrame.add(helpTitleLabel);
                ...
                JTextArea instruction = new JTextArea("Step1 :\n         Randomly select at least 10 disease-free rice plants or hills in a field, where plant population is uniform.\n"
                        ...
                        + "\nNote :\n         Use the LCC once every 7−10 days starting from the beginning of tillering. Continue this process up to 5−10 days after panicle initiation."); helpFrame.add(instruction);
            ...
            if(crop.getSelectedItem().equals("Paddy")) {
                ImageIcon paddyLCC = new ImageIcon("C:\\Users\\HP\\Desktop\\LCC rice.png");
                JLabel paddyLCCLabel = new JLabel(paddyLCC);
                fertilizerFrame.add(paddyLCCLabel);
                paddyLCCLabel.setBounds(640, 110, 600, 200);
            }
            else if(crop.getSelectedItem().equals("Wheat")) {
                ImageIcon wheatIcon = new ImageIcon("C:\\Users\\HP\\Desktop\\LCC wheat.png");
        ...
        JButton goToMenu = new JButton("menu"); fertilizerFrame.add(goToMenu);
